...
/**
 * A DTO for the {@link com.cmspro.base.microservice.domain.TaskAttachmentOthers} entity.
 */
public class TaskAttachmentOthersDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TaskAttachmentOthersDTO)) {
            return false;
        }

        return id != null && id.equals(((TaskAttachmentOthersDTO) o).id);
    }
    ...
    public String toString() {
        return "TaskAttachmentOthersDTO{" +
            "id=" + getId() +
