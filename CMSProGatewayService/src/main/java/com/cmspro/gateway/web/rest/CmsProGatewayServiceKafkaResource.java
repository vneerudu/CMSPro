...
@RestController
@RequestMapping("/api/cms-pro-gateway-service-kafka")
public class CmsProGatewayServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CmsProGatewayServiceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CmsProGatewayServiceKafkaResource(KafkaProperties kafkaProperties) {
