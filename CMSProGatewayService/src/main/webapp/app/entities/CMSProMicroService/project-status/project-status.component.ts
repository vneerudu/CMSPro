...
export default class ProjectStatus extends mixins(AlertMixin) {
  ...
  public removeProjectStatus(): void {
    this.projectStatusService()
      ...
      .then(() => {
        const message = this.$t('cmsProGatewayServiceApp.cmsProMicroServiceProjectStatus.deleted', { param: this.removeId });
