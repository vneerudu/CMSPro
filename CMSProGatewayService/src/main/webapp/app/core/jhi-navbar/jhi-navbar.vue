<template>
    <b-navbar toggleable="md" type="dark" class="bg-primary">
        <b-navbar-brand class="logo" b-link to="/">
            ...
            <span v-text="$t('global.title')" class="navbar-title">CMSProGatewayService</span> <span class="navbar-version">{{version}}</span>
        </b-navbar-brand>      
        <b-navbar-toggle 
        right 
            ...
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/project">
                        ...
                        <span v-text="$t('global.menu.entities.cmsProMicroServiceProject')">Project</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/project-statuses">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.cmsProMicroServiceProjectStatuses')">ProjectStatuses</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/projects">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.cmsProMicroServiceProjects')">Projects</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/project-status">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.cmsProMicroServiceProjectStatus')">ProjectStatus</span>
                    </b-dropdown-item>
