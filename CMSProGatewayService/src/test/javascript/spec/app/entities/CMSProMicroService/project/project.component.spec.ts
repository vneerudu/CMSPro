...
import ProjectComponent from '@/entities/CMSProMicroService/project/project.vue';
import ProjectClass from '@/entities/CMSProMicroService/project/project.component';
