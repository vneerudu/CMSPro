...
const baseApiUrl = 'services/cmsprobaseservice/api/countries';
const baseSearchApiUrl = 'services/cmsprobaseservice/api/_search/countries?query=';
...
export default class CountryService {
  ...
  public find(id: string): Promise<ICountry> {
