...
import { Projects } from '@/shared/model/CMSProBaseService/projects.model';
...
describe('Service Tests', () => {
  describe('Projects Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Projects('ID', 'AAAAAAA', 'AAAAAAA', currentDate, currentDate, currentDate, 'AAAAAAA', currentDate);
    });
        ...
        const returnedFromService = Object.assign(
          {
            ...
            lastUpdate: format(currentDate, DATE_FORMAT),
