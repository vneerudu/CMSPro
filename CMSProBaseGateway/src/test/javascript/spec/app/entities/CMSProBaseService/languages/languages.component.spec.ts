...
import LanguagesComponent from '@/entities/CMSProBaseService/languages/languages.vue';
import LanguagesClass from '@/entities/CMSProBaseService/languages/languages.component';
...
describe('Component Tests', () => {
  describe('Languages Management Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<LanguagesClass>(LanguagesComponent, {
        store,
        i18n,
        localVue,
    ...
    it('should not load a page if the page is the same as the previous page', () => {
      ...
      // THEN
      expect(languagesServiceStub.retrieve.called).toBeFalsy();
    });
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(languagesServiceStub.retrieve.callCount).toEqual(3);
    ...
    it('Should call delete service on confirmDelete', async () => {
      ...
      expect(languagesServiceStub.retrieve.callCount).toEqual(2);
    });
  });
});
